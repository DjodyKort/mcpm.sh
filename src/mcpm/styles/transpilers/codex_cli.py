"""Codex CLI style transpiler -- .agents/skills/mcpm-output-style/SKILL.md (Tier 2)."""
...
class CodexCliStyleTranspiler(BaseStyleTranspiler):
    ...
    def get_output_path(self, style: StyleConfig, project_root: Path) -> Path:
        return project_root / ".agents" / "skills" / "mcpm-output-style" / "SKILL.md"
