"""Continue.dev style transpiler -- .continue/rules/mcpm-output-style.md (Tier 2)."""
...
class ContinueDevStyleTranspiler(BaseStyleTranspiler):
    client_key = "continue"
    ...
    def get_output_path(self, style: StyleConfig, project_root: Path) -> Path:
        return project_root / ".continue" / "rules" / "mcpm-output-style.md"
