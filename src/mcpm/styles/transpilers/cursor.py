"""Cursor style transpiler -- .cursor/rules/mcpm-output-style/RULE.md (Tier 2)."""
...
class CursorStyleTranspiler(BaseStyleTranspiler):
    client_key = "cursor"
    display_name = "Cursor"
    tier = 2
    ...
    def get_output_path(self, style: StyleConfig, project_root: Path) -> Path:
        return project_root / ".cursor" / "rules" / "mcpm-output-style" / "RULE.md"
